...
def main():
    ...
    car_input['transmission']  = st.selectbox('transmission', ['Manual','Automatic'])
    ...
    car_input['Condition'] = st.selectbox('Damage', ['Heavy damage', 'moderate damage','no damage'])
    car_input['year']  = st.number_input('Year', value=2021)


    filtered_cols=['age','model_GRANDLAND','mileage','body_Hatchback','trim_level_base','model_CORSA','engine','transmission_Manual', 'body_SUV','BHP']
